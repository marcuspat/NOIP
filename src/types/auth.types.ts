...
export interface JWTPayload {
  ...
  type: 'access' | 'refresh';
  /**
   * Whether this session has completed MFA verification (initial login
   * or step-up). Required by `requireMFAVerified` middleware
   * (ADR-0009). Optional for backwards compatibility with tokens
   * minted before wave 3.
   */
  mfaVerified?: boolean;
}
